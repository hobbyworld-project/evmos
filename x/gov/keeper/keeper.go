...
func NewKeeper(
	...
	bankKeeper types.BankKeeper, stakingKeeper types.StakingKeeper, evmKeeper types.EVMKeeper,
	router *baseapp.MsgServiceRouter, config types.Config, authority string, feeCollectorName string,
) *Keeper {
