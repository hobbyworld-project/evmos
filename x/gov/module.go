...
import (
	...
	"github.com/evmos/evmos/v15/x/gov/simulation"
...
func NewAppModule(
	...
	ak govtypes.AccountKeeper, bk govtypes.BankKeeper, ek govtypes.EVMKeeper, ss govtypes.ParamSubspace,
) AppModule {
	return AppModule{
...
type GovInputs struct {
	...
	EvmKeeper     govtypes.EVMKeeper
	DistriKeeper  govtypes.DistributionKeeper
	// LegacySubspace is used solely for migration of x/params managed parameters
...
func ProvideModule(in GovInputs) GovOutputs {
	...
	m := NewAppModule(in.Cdc, k, in.AccountKeeper, in.BankKeeper, in.EvmKeeper, in.LegacySubspace)
